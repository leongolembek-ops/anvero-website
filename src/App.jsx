...
function ProductWorkspace() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[650px]">
      ...
      <div className="md:hidden overflow-hidden rounded-[20px] border border-slate-300/80 bg-white shadow-[0_18px_42px_rgba(23,48,46,.13)]">
        <div className="border-b border-slate-200 bg-[#f8faf9] px-4 py-3.5">
          <div className="flex items-start justify-between gap-3"><div><p className="text-[9px] font-bold uppercase tracking-[.14em] text-[#176b68]">Angebotsvorgang #1048</p><p className="mt-1 text-[15px] font-bold tracking-[-.02em] text-slate-950">Bürogebäude Hamburg</p><p className="mt-0.5 text-[10px] text-slate-500">Unterhaltsreinigung · Demo-Daten</p></div><StatusPill>Prüfung offen</StatusPill></div>
        </div>
        <div className="p-3.5">
          <div className="mb-3 flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-2.5 py-2"><div className="flex items-center gap-1.5"><span className="h-2 w-2 rounded-full bg-[#176b68]"/><span className="text-[9px] font-bold uppercase tracking-[.1em] text-[#176b68]">Anfrage</span></div><Icon name="arrow" size={13} className="text-slate-300"/><div className="flex items-center gap-1.5"><span className="h-2 w-2 rounded-full bg-[#176b68]"/><span className="text-[9px] font-bold uppercase tracking-[.1em] text-[#176b68]">Daten</span></div><Icon name="arrow" size={13} className="text-slate-300"/><div className="flex items-center gap-1.5"><span className="h-2 w-2 rounded-full bg-[#176b68]"/><span className="text-[9px] font-bold uppercase tracking-[.1em] text-[#176b68]">Entwurf</span></div><Icon name="arrow" size={13} className="text-slate-300"/><div className="flex items-center gap-1.5"><span className="h-2 w-2 rounded-full bg-[#d5a92f]"/><span className="text-[9px] font-bold uppercase tracking-[.1em] text-[#79591c]">Freigabe</span></div></div>
          <div className="relative space-y-2.5">
            <div className="absolute bottom-8 left-[17px] top-8 w-px bg-[#aac8c3]"/>
            <div className="relative flex gap-3 rounded-xl border border-slate-200 bg-white p-3"><span className="relative z-10 grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-[#e5f1ef] text-[#176b68]"><Icon name="mail" size={15}/></span><div className="min-w-0"><div className="flex items-center justify-between gap-2"><p className="text-[11px] font-bold text-slate-900">1 · Anfrage eingegangen</p><span className="text-[9px] text-slate-400">09:14</span></div><p className="mt-1 text-[10px] text-slate-600">Büroreinigung in Hamburg · 1.200 m² · 3× wöchentlich</p></div></div>
            <div className="relative flex gap-3 rounded-xl border border-[#b9ddd3] bg-[#f2faf8] p-3"><span className="relative z-10 grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-[#cdebdc] text-[#17654c]"><Icon name="search" size={15}/></span><div className="min-w-0"><div className="flex items-center justify-between gap-2"><p className="text-[11px] font-bold text-slate-900">2 · ANVERO strukturiert</p><span className="rounded-full bg-white px-2 py-0.5 text-[9px] font-bold text-[#17654c]">automatisch</span></div><div className="mt-2 grid grid-cols-3 gap-1"><span className="rounded-md bg-white px-1.5 py-1 text-center text-[9px] text-slate-600">Objekt</span><span className="rounded-md bg-white px-1.5 py-1 text-center text-[9px] text-slate-600">Fläche</span><span className="rounded-md bg-white px-1.5 py-1 text-center text-[9px] text-slate-600">Frequenz</span></div></div></div>
            <div className="relative flex gap-3 rounded-xl border border-[#ead8ac] bg-[#fffbf1] p-3"><span className="relative z-10 grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-[#fff0c8] text-[#79591c]"><Icon name="send" size={15}/></span><div className="min-w-0"><div className="flex items-center justify-between gap-2"><p className="text-[11px] font-bold text-slate-900">3 · Rückfrage ausgelöst</p><span className="text-[9px] font-bold text-[#79591c]">offen</span></div><p className="mt-1 text-[10px] text-slate-600">Welche Reinigungszeiten sind gewünscht?</p><p className="mt-1 text-[9px] font-semibold text-[#79591c]">Antwort fließt automatisch zurück in den Vorgang</p></div></div>
            <div className="relative flex gap-3 rounded-xl border border-[#8fc6b2] bg-[#effaf5] p-3"><span className="relative z-10 grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-[#cdebdc] text-[#17654c]"><Icon name="file" size={15}/></span><div className="min-w-0 flex-1"><div className="flex items-center justify-between gap-2"><p className="text-[11px] font-bold text-slate-900">4 · Angebotsentwurf bereit</p><StatusPill tone="green">prüfen</StatusPill></div><p className="mt-1 text-[10px] text-slate-600">Leistungen zusammengestellt · Regeln angewendet</p><div className="mt-2 flex items-center justify-between rounded-lg border border-[#b9ddd3] bg-white px-2.5 py-2"><span className="text-[9px] font-semibold text-slate-500">Versand</span><span className="text-[9px] font-bold text-[#79591c]">bis Freigabe gesperrt</span></div><button type="button" className="mt-2.5 flex min-h-9 w-full items-center justify-center gap-2 rounded-lg bg-[#176b68] px-3 text-[10px] font-bold text-white transition hover:bg-[#125c59] focus:outline-none focus-visible:ring-4 focus-visible:ring-[#176b68]/20"><Icon name="shield" size={13}/>Angebot prüfen und freigeben</button></div></div>
          </div>
          <div className="mt-2.5 flex items-center justify-center gap-2 rounded-lg bg-slate-900 px-3 py-2 text-[10px] font-semibold text-slate-200"><Icon name="refresh" size={13} className="text-[#8ed0c9]"/>Nach Freigabe: Follow-up nach Ihren Regeln</div>
        </div>
      </div>
      <div className="hidden md:block overflow-hidden rounded-[22px] border border-slate-300/80 bg-white shadow-[0_28px_70px_rgba(23,48,46,.14),0_4px_12px_rgba(15,23,42,.05)]">
...
function Hero() {
  return (
    <section id="top" className="relative overflow-hidden border-b border-slate-200 bg-[#f8faf9]">
      ...
      <div className="relative mx-auto grid max-w-[1180px] items-center gap-10 px-5 py-11 sm:gap-14 sm:py-20 lg:grid-cols-[.82fr_1.18fr] lg:px-8 lg:py-24">
        <div>
          ...
          <p className="mt-6 max-w-[610px] text-[18px] font-bold leading-7 tracking-[-.02em] text-[#102322] md:mt-7 md:text-[20px]">Ihre Mitarbeiter sollen Aufträge gewinnen – nicht E-Mails sortieren.</p>
...
function Problem() {
  return <section className="bg-white py-14 sm:py-28"><div className="mx-auto max-w-[1080px] px-5 lg:px-8"><div className="grid gap-8 lg:grid-cols-[.85fr_1.15fr] lg:gap-20"><div><p className="section-kicker">Der heutige Ablauf</p><h2 className="section-title">Eine Anfrage ist selten nur eine E-Mail.</h2><p className="section-copy">Dahinter stehen Flächen, Reinigungsarten, Frequenzen und Kalkulationsregeln. Diese Informationen jedes Mal manuell zusammenzutragen, erzeugt unnötigen Abstimmungsaufwand.</p></div><div className="relative"><div className="hidden grid-cols-2 gap-px overflow-hidden rounded-2xl border border-slate-200 bg-slate-200 sm:grid">{manualTasks.map((task,i)=><div key={task} className="flex min-h-[72px] items-center gap-3 bg-[#fbfcfc] px-4 py-3"><span className="font-mono text-[10px] text-slate-400">{String(i+1).padStart(2,'0')}</span><span className="text-sm font-semibold text-slate-700">{task}</span></div>)}</div><div className="grid gap-2 sm:hidden"><div className="rounded-xl border border-slate-200 bg-[#fbfcfc] px-4 py-3"><p className="text-xs font-bold text-slate-800">Informationen zusammensuchen</p><p className="mt-1 text-[11px] leading-4 text-slate-500">E-Mail lesen, Angaben erkennen und Daten zuordnen.</p></div><div className="rounded-xl border border-slate-200 bg-[#fbfcfc] px-4 py-3"><p className="text-xs font-bold text-slate-800">Fehlende Angaben nachfragen</p><p className="mt-1 text-[11px] leading-4 text-slate-500">Rückfragen formulieren und Antworten verarbeiten.</p></div><div className="rounded-xl border border-slate-200 bg-[#fbfcfc] px-4 py-3"><p className="text-xs font-bold text-slate-800">Kalkulation und Angebot</p><p className="mt-1 text-[11px] leading-4 text-slate-500">Leistungen zusammenstellen, kalkulieren und Dokumente vorbereiten.</p></div></div><div className="mt-4 rounded-xl bg-[#102c2b] p-4 text-white sm:mt-5 sm:p-5"><p className="text-[13px] leading-5 sm:text-sm sm:leading-6"><strong>Viele kleine Schritte.</strong> Genau hier setzt ANVERO an.</p></div></div></div></div></section>;
}
...
function Workflow() {
  const mobileSteps = [
    ["mail", "Anfrage", "Kundenanfrage kommt per E-Mail an."],
    ["send", "Rückfragen", "Fehlende Angaben werden automatisch nachgefragt."],
    ["settings", "Angebot", "Antworten und Kalkulationsregeln fließen in den Entwurf ein."],
    ["shield", "Freigabe und Follow-up", "Ihr Team gibt frei; danach kann automatisch nachgefasst werden."],
  ];
  return <section id="workflow" className="border-y border-slate-200 bg-[#f2f6f5] py-14 sm:py-28"><div className="mx-auto max-w-[1180px] px-5 lg:px-8"><div className="mb-9 max-w-2xl sm:mb-14"><p className="section-kicker">Ein Vorgang statt vieler Einzelschritte</p><h2 className="section-title">Von der Anfrage bis zum Follow-up.</h2><p className="section-copy">Aus Nachrichten entsteht ein nachvollziehbarer Angebotsvorgang – mit einem verbindlichen Kontrollpunkt vor dem Versand.</p></div><div className="relative"><div className="hidden md:block"><div className="absolute bottom-8 left-[23px] top-8 w-px bg-[#aac8c3]"/><div className="grid gap-2 sm:gap-3 md:grid-cols-3">{workflow.map(([icon,title,text],i)=><article key={title} className={`group relative rounded-2xl border p-4 sm:p-5 transition duration-200 hover:-translate-y-0.5 hover:shadow-lg ${i===6 ? 'border-[#d9b866] bg-[#fff9ea]' : i===7 ? 'border-[#8fc6b2] bg-[#effaf5]' : 'border-slate-200 bg-white'}`}><div className="mb-3 flex items-center justify-between sm:mb-5"><span className={`grid h-9 w-9 place-items-center rounded-xl sm:h-10 sm:w-10 ${i===6 ? 'bg-[#f4dfaa] text-[#725415]' : i===7 ? 'bg-[#cdebdc] text-[#17654c]' : 'bg-[#e5f1ef] text-[#176b68]'}`}><Icon name={icon} size={18}/></span><span className="font-mono text-[10px] font-bold tracking-[.14em] text-slate-400">{String(i+1).padStart(2,'0')}</span></div><h3 className="text-[14px] font-bold text-slate-900 sm:text-[15px]">{title}</h3><p className="mt-1 text-[12px] leading-5 text-slate-500 sm:mt-2 sm:text-[13px]">{text}</p>{i===6&&<div className="mt-3 text-[9px] font-bold uppercase tracking-wider text-[#79591c] sm:mt-4 sm:text-[10px]">Verbindlicher Kontrollpunkt</div>}</article>)}</div></div><div className="md:hidden space-y-2.5">{mobileSteps.map(([icon,title,text],i)=><div key={title} className="relative flex gap-3 rounded-xl border border-slate-200 bg-white p-4"><div className="relative flex shrink-0 flex-col items-center"><span className={`grid h-9 w-9 place-items-center rounded-xl ${i===3 ? 'bg-[#cdebdc] text-[#17654c]' : 'bg-[#e5f1ef] text-[#176b68]'}`}><Icon name={icon} size={17}/></span>{i<mobileSteps.length-1&&<span className="absolute top-10 h-7 w-px bg-[#aac8c3]"/>}</div><div className="pt-0.5"><p className="text-[13px] font-bold text-slate-900">{title}</p><p className="mt-1 text-[12px] leading-5 text-slate-500">{text}</p></div></div>)}</div><div className="mt-8 flex justify-center"><Button href="#demo">Kostenlose Live-Demo buchen</Button></div></div></div></section>;
}
...
function App() {
 ...
 `}</style><Header/><main><Hero/><Problem/><Workflow/><Control/><Specialization/><Demo/><FAQ/></main><Footer/><MobileStickyCTA/></>;
}
