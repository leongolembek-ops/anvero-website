...
function ProductWorkspace() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[650px]">
      ...
      <div className="md:hidden overflow-hidden rounded-[20px] border border-slate-300/80 bg-white shadow-[0_20px_50px_rgba(23,48,46,.12)]">
        <div className="border-b border-slate-200 bg-[#f8faf9] px-4 py-3">
          <div className="flex items-center justify-between gap-3">
            <div><p className="text-[10px] font-bold uppercase tracking-[.14em] text-[#176b68]">Beispielansicht</p><p className="mt-1 text-sm font-bold text-slate-900">Anfrage bis Angebot</p></div>
            <StatusPill>Prüfung offen</StatusPill>
          </div>
        </div>
        <div className="p-4">
          <div className="mb-4 flex gap-1.5" role="tablist" aria-label="Mobile Prozessschritte">
            {tabs.map((tab, i) => <button key={tab} onClick={() => setStage(i)} role="tab" aria-selected={stage === i} className={`flex-1 rounded-lg px-1 py-2 text-[10px] font-bold transition ${stage === i ? "bg-[#e5f1ef] text-[#176b68]" : "bg-slate-50 text-slate-400"}`}>{tab}</button>)}
          </div>
          <div className="space-y-2.5">
            <div className={`rounded-xl border p-3 ${stage === 0 ? "border-[#83b9b4] bg-[#f2faf8]" : "border-slate-200 bg-white"}`}><div className="flex items-center gap-2 text-xs font-bold text-slate-700"><Icon name="mail" size={15}/>Kundenanfrage</div><p className="mt-2 text-[11px] leading-5 text-slate-500">Bürogebäude · Hamburg · 1.200 m² · 3× wöchentlich</p></div>
            <div className={`rounded-xl border p-3 ${stage === 1 ? "border-[#83b9b4] bg-[#f2faf8]" : "border-[#ead8ac] bg-[#fffbf1]"}`}><div className="flex items-center justify-between gap-2"><span className="text-xs font-bold text-slate-700">Fehlende Angabe</span><StatusPill tone={stage > 1 ? "green" : "amber"}>{stage > 1 ? "Beantwortet" : "Rückfrage"}</StatusPill></div><p className="mt-2 text-[11px] text-slate-500">Welche Reinigungszeiten sind gewünscht?</p></div>
            <div className={`rounded-xl border p-3 ${stage === 2 ? "border-[#83b9b4] bg-[#f2faf8]" : "border-slate-200 bg-white"}`}><div className="flex items-center gap-2 text-xs font-bold text-slate-700"><Icon name="settings" size={15}/>Kalkulation und Entwurf</div><p className="mt-2 text-[11px] leading-5 text-slate-500">Ihre Regeln werden angewendet. Der Angebotsentwurf ist vorbereitet.</p></div>
            <div className={`rounded-xl border p-3 ${stage === 3 ? "border-[#83b9b4] bg-[#f2faf8]" : "border-slate-200 bg-[#fbfcfc]"}`}><div className="flex items-center gap-2 text-xs font-bold text-slate-700"><Icon name="shield" size={15}/>Prüfung und Freigabe</div><p className="mt-2 text-[11px] text-slate-500">Versand erst nach der Entscheidung Ihres Teams.</p></div>
          </div>
          <div className="mt-3 flex items-center gap-2 rounded-lg bg-slate-900 px-3 py-2.5 text-[10px] leading-4 text-slate-200"><Icon name="refresh" size={14} className="shrink-0 text-[#8ed0c9]"/>Follow-up nach Ihren Regeln</div>
        </div>
      </div>
    ...
    <section id="top" className="relative overflow-hidden border-b border-slate-200 bg-[#f8faf9]">
      ...
      <div className="relative mx-auto grid max-w-[1180px] items-center gap-10 px-5 py-11 sm:gap-14 sm:py-20 lg:grid-cols-[.82fr_1.18fr] lg:px-8 lg:py-24">
        <div>
          ...
          <p className="mt-6 max-w-[610px] text-[16px] leading-7 text-slate-600 md:mt-7 md:text-[17px]">ANVERO führt Ihre Kundenanfragen automatisch durch den Angebotsprozess – von fehlenden Angaben und Rückfragen bis zum vorbereiteten Angebotsentwurf.</p><p className="mt-3 max-w-[610px] text-[15px] font-semibold leading-6 text-slate-800 md:text-[16px]">Ihr Team prüft und gibt jedes Angebot vor dem Versand frei.</p>
